...
import com.nugget.hios.databinding.FragmentTermsconditionsBinding;

public class TermsConditionsFragment extends Fragment {

    private termsconditionsViewModel termsconditionsViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        termsconditionsViewModel =
                new ViewModelProvider(this).get(termsconditionsViewModel.class);
        ...
        /*if (WebViewFeature.isFeatureSupported(WebViewFeature.FORCE_DARK)) {
            ...
            webView.loadUrl("https://thehighlandcafe.github.io/hiosmobile/terms-conditions.html");
