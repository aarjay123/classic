...
import com.nugget.hios.databinding.FragmentTaxiBinding;

public class TaxiFragment extends Fragment {

    private @NonNull FragmentTaxiBinding binding;

    @RequiresApi(api = Build.VERSION_CODES.Q)
    @SuppressLint("WrongConstant")
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        com.nugget.hios.ui.taxi.TaxiViewModel TaxiViewModel = new ViewModelProvider(this).get(TaxiViewModel.class);
        ...
        webView.loadUrl("https://aarjay123.github.io/hiosmobile/taxi.html");
