...
import com.nugget.hios.databinding.FragmentComingsoonBinding;

public class ComingsoonFragment extends Fragment {

    private @NonNull FragmentComingsoonBinding binding;

    @RequiresApi(api = Build.VERSION_CODES.Q)
    @SuppressLint("WrongConstant")
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        com.nugget.hios.ui.comingsoon.ComingsoonViewModel ComingsoonViewModel = new ViewModelProvider(this).get(ComingsoonViewModel.class);
